<?php
  ...
  $company_info = $this->User_Model->get_info_arr_fields('company_name','company_id', $mani_company_id, 'company');
?>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block"><?php echo $company_info[0]['company_name']; ?></a>
      </div>
    </div>
    <!-- Sidebar Menu -->
    <nav class="mt-2">
